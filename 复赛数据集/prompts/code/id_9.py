...
budget = 42400
start_date = "2025年11月01日"
end_date = "2025年11月04日"
travel_days = 4
peoples = 2
...
def generate_poi(model, intra_city_trans):
    ...
    return {
        "query_id": "9",
        "query": "我计划和朋友共2人于2025年11月01日从北京市出发，前往广州市去旅游，并且在2025年11月04日回到北京市，预算大概42400元。旅行期间入住酒店价格不低于700元每晚，尽量花光预算，并且出行采用的士。帮我规划一份旅行方案。",
