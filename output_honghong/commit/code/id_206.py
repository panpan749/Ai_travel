...
if __name__ == '__main__':
    ...
    user_question = """我计划在2025年09月05日至2025年09月09日从苏州市到武汉市进行为期5天2人的旅行，总预算15700元，希望尽量控制花费。要求2025年09月05日上午从盛泽站乘坐高铁出发，3月15日中午从武汉市搭乘高铁返回盛泽站，请帮我规划一份经济实惠的5日游攻略。"""
    ...
    try:
        ...
        from output_honghong.commit.mock.mock_93 import get_mock_data, generate_stage
