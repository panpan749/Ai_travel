...
async def test():
    ...
    with open(problem_file, 'r', encoding='utf-8') as f:
        ...
        for item in json_problems:
            problems[item['question_id']] = item['question'] 
    problems['10086'] = "我计划于2025年07月13日至2025年07月20日从武汉市出发，先前往成都市旅游3天，之后前往洛阳市游玩5天，总花费控制在最低水平，在成都时必须包含百花潭公园。2025年07月13日上午从武汉站乘坐高铁出发，2025年07月15日晚上从成都东站离开，并于当晚抵达洛阳市住宿。在洛阳期间，我会游览白马寺，用餐选择鲁记卤肉凉菜和鲜羊肉汤店，住宿安排在洛阳非凡·云联酒店，并乘坐Z136次列车从洛阳站返回武昌站。市内交通可使用公共交通或打车。"
    test_id = '10086'
